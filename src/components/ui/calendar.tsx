  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_button:
          "inline-flex h-8 w-8 items-center justify-center rounded-md p-0 font-normal hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground aria-selected:opacity-100",
        selected:
